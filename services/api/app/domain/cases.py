...
ALLOWED_TRANSITIONS: dict[CaseStatus, set[CaseStatus]] = {
    ...
    CaseStatus.DUPLICATE_REVIEW: {CaseStatus.SPECIALIST_ANALYSIS, CaseStatus.RISK_REVIEW, CaseStatus.EVIDENCE_BUILDING, CaseStatus.APPROVAL_PENDING, CaseStatus.REJECTED, CaseStatus.CANCELLED},
    CaseStatus.RISK_REVIEW: {CaseStatus.DUPLICATE_REVIEW, CaseStatus.EVIDENCE_BUILDING, CaseStatus.APPROVAL_PENDING, CaseStatus.REJECTED, CaseStatus.CANCELLED},
    ...
    CaseStatus.ERP_SYNC_PENDING: {
        CaseStatus.COMPLETED,
        CaseStatus.ERP_SYNC_FAILED,
    ...
    CaseStatus.INVOICE_MATCHING: {CaseStatus.EXCEPTION_CLASSIFIED, CaseStatus.APPROVAL_PENDING, CaseStatus.BLOCKED_DUPLICATE, CaseStatus.HOLD, CaseStatus.NEEDS_CLARIFICATION, CaseStatus.VERIFICATION_FAILED, CaseStatus.FAILED},
    ...
    CaseStatus.BLOCKED_DUPLICATE: {CaseStatus.DUPLICATE_REVIEW, CaseStatus.RISK_REVIEW, CaseStatus.HOLD, CaseStatus.APPROVAL_PENDING, CaseStatus.REJECTED, CaseStatus.NEEDS_CLARIFICATION, CaseStatus.CANCELLED},
    CaseStatus.HOLD: {CaseStatus.DUPLICATE_REVIEW, CaseStatus.RISK_REVIEW, CaseStatus.APPROVAL_PENDING, CaseStatus.REJECTED, CaseStatus.NEEDS_CLARIFICATION, CaseStatus.CANCELLED},
}
