...
ALLOWED_TRANSITIONS: dict[CaseStatus, set[CaseStatus]] = {
    ...
    CaseStatus.DOCUMENT_PROCESSING: {CaseStatus.SPECIALIST_ANALYSIS, CaseStatus.NEEDS_CLARIFICATION, CaseStatus.FAILED, CaseStatus.CANCELLED},
    ...
    CaseStatus.NEEDS_CLARIFICATION: {CaseStatus.DOCUMENT_PROCESSING, CaseStatus.SPECIALIST_ANALYSIS, CaseStatus.CANCELLED},
